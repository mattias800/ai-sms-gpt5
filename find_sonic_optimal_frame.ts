...
console.log('Finding optimal Sonic title screen frame');
...
// Test frames from 400 to 1000 in steps of 50
const testFrames = [];
...
for (const targetFrame of testFrames) {
  ...
  try {
    ...
    const filename = `traces/sonic_frame_${targetFrame}_search.png`;
