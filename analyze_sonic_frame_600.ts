...
console.log('Analyzing Sonic title screen at frame 600');
...
try {
  ...
  const filename = 'traces/sonic_frame_600_title_screen.png';
  ...
  if (parseFloat(successRate) >= 75) {
    console.log(`\n🎯 RECOMMENDATION: Frame 600 is a good candidate for Sonic title screen!`);
