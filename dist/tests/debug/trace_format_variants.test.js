...
describe('Debug trace formatter branch variants', () => {
    it('handles no bytes/regs with lowercase hex and IRQ interrupt', () => {
        const ev = {
            pcBefore: 0x1234,
            opcode: null,
            cycles: 13,
    ...
    it('handles provided bytes and regs with lowercase hex', () => {
        const regs = {
            a: 0x12, f: 0x00,
            b: 0x34, c: 0x56,
            d: 0x78, e: 0x9a,
    ...
    it('formats NMI acceptance with NMI tag', () => {
        const ev = {
            pcBefore: 0xabcd,
            opcode: null,
            cycles: 11,
...
//# sourceMappingURL=trace_format_variants.test.js.map