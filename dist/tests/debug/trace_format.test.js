...
describe('Debug trace formatter', () => {
    it('formats lines with text, bytes, cycles, and regs/flags when available', () => {
    ...
    it('formats interrupt acceptance as <INT> with IRQ tag and cycles', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=trace_format.test.js.map