...
describe('VDP H/VCounter behavior', () => {
    it('0x7E HCounter increases within a line and changes over time', () => {
        const vdp = createVDP();
    ...
    it('0x7F VCounter reflects scanline and advances across lines', () => {
        const vdp = createVDP();
    ...
    it('HCounter snaps to 0xB0 near 0xB0 even before hblank plateau', () => {
        const vdp = createVDP();
        const gs = vdp.getState?.();
        const cpl = (gs?.cyclesPerLine ?? 228);
...
//# sourceMappingURL=vdp_hcounter.test.js.map