...
describe('Z80 CB rotate/shift variant coverage', () => {
    it('RRC C, RR E(with carry), SLA H, SRA L, SLL A', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program:
        // LD C,0x02; RRC C; LD E,0x00; RR E; LD H,0x80; SLA H; LD L,0x81; SRA L; LD A,0x40; SLL A; HALT
        mem.set([
            0x0e, 0x02, 0xcb, 0x09, 0x1e, 0x00, 0xcb, 0x1b, 0x26, 0x80, 0xcb, 0x24, 0x2e, 0x81, 0xcb,
            0x2d, 0x3e, 0x40, 0xcb, 0x37, 0x76,
        ], 0x0000);
...
//# sourceMappingURL=z80_cb_variants.test.js.map