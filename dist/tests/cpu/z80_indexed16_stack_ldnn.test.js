...
describe('Z80 IX/IY stack and (nn) transfers: PUSH/POP IX/IY, LD (nn),IX/IY and LD IX/IY,(nn)', () => {
    it('PUSH IX (DD E5) then POP IY (FD E1)', () => {
    ...
    it('LD (nn),IX (DD 22) and LD IX,(nn) (DD 2A)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('LD (nn),IY (FD 22) and LD IY,(nn) (FD 2A)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_indexed16_stack_ldnn.test.js.map