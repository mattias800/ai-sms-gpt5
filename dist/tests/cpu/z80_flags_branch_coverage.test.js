...
describe('Flags and conditional branch coverage', () => {
    it('CCF toggles carry and sets H from previous C', () => {
    ...
    it('RET NZ: takes pop when Z=0, otherwise falls through', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_flags_branch_coverage.test.js.map