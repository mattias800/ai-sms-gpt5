...
describe('Z80 ED block compare: CPI/CPD/CPIR/CPDR', () => {
    it('CPI compares A with (HL), updates HL++, BC--, flags, cycles 16, preserves C', () => {
    ...
    it('CPD compares with (HL), HL--, BC--, flags, cycles 16', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: CPD; HALT
    ...
    it('CPIR repeats until match with 21 cycles on repeats then 16 on last', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: CPIR; HALT
    ...
    it('CPDR repeats downwards until match', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: CPDR; HALT
...
//# sourceMappingURL=z80_ed_block_compare.test.js.map