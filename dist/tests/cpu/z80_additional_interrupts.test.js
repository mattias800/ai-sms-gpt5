...
describe('Z80 additional interrupt coverage', () => {
    it('NMI while halted is accepted on next step and wakes CPU (11 cycles, PC=0x0066)', () => {
    ...
    it('IM1 IRQ accepted immediately when next instruction is not HALT (preempts NOP)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_additional_interrupts.test.js.map