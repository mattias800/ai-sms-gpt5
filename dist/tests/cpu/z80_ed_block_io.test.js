...
describe('Z80 ED block I/O: INI/IND/INIR/INDR/OUTI/OUTD/OTIR/OTDR', () => {
    it('INI writes from port to (HL), increments HL, decrements B (16 cycles)', () => {
    ...
    it('OUTI writes (HL) to port, increments HL, decrements B (16 cycles)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('IND writes from port to (HL), decrements HL, decrements B', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('OUTD writes (HL) to port, decrements HL, decrements B', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('INIR repeats until B==0 (21/16 cycles) and fills memory', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('OTDR repeats until B==0 (21/16 cycles) and moves memory upwards', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_ed_block_io.test.js.map