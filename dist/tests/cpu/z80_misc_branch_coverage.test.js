...
describe('Misc branch coverage: EX DE,HL and JP (IX/IY)', () => {
    ...
    it('DD JP (IX) and FD JP (IY) set PC and take 8 cycles', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // DD E9; FD E9
...
//# sourceMappingURL=z80_misc_branch_coverage.test.js.map