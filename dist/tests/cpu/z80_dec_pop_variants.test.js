...
describe('Z80 additional DEC dd branches and POP qq variants', () => {
    it('DEC HL and DEC SP update correctly (6 cycles)', () => {
    ...
    it('POP BC/DE/HL read from stack and update SP', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_dec_pop_variants.test.js.map