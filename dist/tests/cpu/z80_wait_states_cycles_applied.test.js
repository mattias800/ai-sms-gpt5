...
const step = (cpu) => cpu.stepOne();
describe('Z80 wait-states applied to reported cycles when enabled', () => {
    it('NOP cycles include wait penalties when includeWaitInCycles=true', () => {
    ...
    it('LD (HL),n cycles include wait penalties when includeWaitInCycles=true', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // LD (HL),0x12 ; HALT
    ...
    it('POP HL cycles include memory read penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // POP HL ; HALT
    ...
    it('JP (HL) cycles include opcode fetch penalties (no memory operand)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // JP (HL)
        mem.set([0xe9], 0x0000);
    ...
    it('LDI cycles include opcode fetch and memory read/write penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED A0 (LDI); HALT
    ...
    it('IN A,(n) cycles include opcode/imm fetch penalties and IO penalty', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // IN A,(0x10); HALT
    ...
    it('LDIR repeat step includes repeat-overhead cycles and penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED B0 (LDIR); HALT
    ...
    it('CPIR repeat step includes repeat-overhead cycles and penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED B1 (CPIR); HALT
    ...
    it('CPDR repeat step includes repeat-overhead cycles and penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED B9 (CPDR); HALT
    ...
    it('INDR repeat step includes opcode, prefix, and I/O/memory penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED BA (INDR); HALT
    ...
    it('OTIR repeat step includes opcode, prefix, memory read and I/O penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED B3 (OTIR); HALT
    ...
    it('INIR repeat step includes opcode, prefix, memory write and I/O penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED B2 (INIR); HALT
    ...
    it('OTDR repeat step includes opcode, prefix, memory read and I/O penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED BB (OTDR); HALT
    ...
    it('IM1 IRQ acceptance includes peek and stack write penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('IM2 IRQ acceptance includes peek, stack writes, and vector table read penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('INI (non-repeat) includes opcode/prefix/sub fetch, IO and memory penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED A2 (INI); HALT
    ...
    it('OUTD (non-repeat) includes opcode/prefix/sub fetch, memory and IO penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // ED AB (OUTD); HALT
    ...
    it('IM0 default (vector) acceptance includes peek and stack write penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('IM0 injected RST opcode acceptance includes peek and stack write penalties', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program at 0x0000: NOP
        mem.set([0x00, 0x76], 0x0000);
...
//# sourceMappingURL=z80_wait_states_cycles_applied.test.js.map