...
describe('Additional DD/FD register mapping coverage', () => {
    it('DD 66 d => LD IXH,(IX+d)', () => {
    ...
    it('DD 04/05 => INC/DEC B still work (4 cycles)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: DD 04 ; DD 05
...
//# sourceMappingURL=z80_ixiy_branch_coverage.test.js.map