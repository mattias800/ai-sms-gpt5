...
describe('Z80 IX/IY 16-bit basics: INC/DEC, ADD IX/IY,pp, LD SP,IX/IY, EX (SP),IY', () => {
    it('INC IX and DEC IY take 10 cycles and update registers', () => {
    ...
    it('ADD IX,SP and LD SP,IY and EX (SP),IY', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_indexed16_more.test.js.map