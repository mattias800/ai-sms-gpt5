...
describe('Z80 ED RRD/RLD', () => {
    it('RRD rotates nibbles between A and (HL), flags from A, C preserved, 18 cycles', () => {
    ...
    it('RLD rotates nibbles left between (HL) and A, flags from A, 18 cycles', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_ed_rrd_rld.test.js.map