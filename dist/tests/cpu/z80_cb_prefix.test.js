...
describe('Z80 CB-prefixed (rotates/shifts, BIT, RES, SET)', () => {
    it('RLC r and RLC (HL) set flags and cycles correctly', () => {
    ...
    it('BIT b,r and BIT b,(HL) set flags, preserve C, and have correct cycles', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('RES and SET for register and (HL) variants', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('RL and SRL affect carry and SZPV flags correctly', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_cb_prefix.test.js.map