...
describe('Z80 IM2 interrupts', () => {
    it('IM2 uses vector table entry and takes 19 cycles', () => {
    ...
    it('IM2 defaults to vector 0xFF when not set', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: LD A,0x40; LD I,A; IM 2; EI; NOP; HALT
        mem.set([0x3e, 0x40, 0xed, 0x47, 0xed, 0x5e, 0xfb, 0x00, 0x76], 0x0000);
    ...
    it('IM2 IRQ pushes return address on stack and clears IFF1', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: LD A,0x40; LD I,A; IM 2; EI; NOP; HALT
        mem.set([0x3e, 0x40, 0xed, 0x47, 0xed, 0x5e, 0xfb, 0x00, 0x76], 0x0000);
...
//# sourceMappingURL=z80_im2_interrupts.test.js.map