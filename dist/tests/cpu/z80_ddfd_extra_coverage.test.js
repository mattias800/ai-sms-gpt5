...
describe('DD/FD extra branch coverage', () => {
    it('DD ADC A,IXH uses carry', () => {
    ...
    it('FD LD A,IYH (FD 7C) maps H->IYH', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('DD LD B,n (DD 06 nn) uses normal regs path', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('DD SUB A,B (DD 90) executes normal regs ALU path', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_ddfd_extra_coverage.test.js.map