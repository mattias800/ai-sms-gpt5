...
describe('Z80 additional coverage', () => {
    it('LD r,r matrix and cycles', () => {
    ...
    it('INC/DEC (HL) cycles and flags', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('ADD overflow and SUB overflow flag (P/V) semantics', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('CP r sets flags without changing A', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('R refresh increments on each fetch; IO bus methods are callable', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_more.test.js.map