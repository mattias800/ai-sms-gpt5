...
describe('Z80 ALU flags coverage', () => {
    it('INC A at 0x7F sets PV on overflow to 0x80 and preserves C', () => {
    ...
    it('DEC A at 0x80 sets PV on overflow to 0x7F and preserves C', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('ADD A,n sets H and PV appropriately on 0x7F + 0x01', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('SUB n sets half-borrow and result flags on 0x10 - 0x01; CP n sets flags without changing A', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // SUB 0x01; CP 0x01
    ...
    it('AND/XOR/OR n set PV as parity of result and H for AND', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_alu_flags_coverage.test.js.map