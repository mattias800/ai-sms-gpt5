...
describe('Z80 JR and JP indexed coverage', () => {
    it('JR d with positive and negative offsets', () => {
    ...
    it('JP (IX) and JP (IY) jump to index register', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_jr_jp_indexed.test.js.map