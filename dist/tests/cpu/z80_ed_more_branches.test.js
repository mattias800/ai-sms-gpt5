...
describe('Z80 ED-prefixed SBC/ADC HL,ss additional branches', () => {
    it('SBC HL,HL yields zero with Z and N set; SBC HL,SP subtracts SP', () => {
        // SBC HL,HL
        {
    ...
    it('ADC HL,HL and ADC HL,SP take 15 cycles and compute sums', () => {
        // ADC HL,HL
        {
            const bus = new SimpleBus();
            const mem = bus.getMemory();
...
//# sourceMappingURL=z80_ed_more_branches.test.js.map