...
describe('Z80 ED pair load/store variants and decrementing block ops', () => {
    it('ED 43: LD (nn),BC and ED 4B: LD BC,(nn)', () => {
    ...
    it('ED 63: LD (nn),HL and ED 6B: LD HL,(nn)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('ED B8: LDDR repeat then finalize with BC=0 and decremented HL/DE', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // LDDR at 0200
    ...
    it('ED 53: LD (nn),DE and ED 7B: LD SP,(nn)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('ED B9: CPDR repeats until match, then stops', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // CPDR at 0300
...
//# sourceMappingURL=z80_ed_more_pairs.test.js.map