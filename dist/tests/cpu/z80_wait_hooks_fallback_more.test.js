...
describe('Z80 wait-state hooks fallback branches (memory write and IO read)', () => {
    it('onMemoryRead + onMemoryWrite accumulate for LD (HL),n', () => {
    ...
    it('onMemoryRead + onIORead accumulate for IN A,(n)', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
...
//# sourceMappingURL=z80_wait_hooks_fallback_more.test.js.map