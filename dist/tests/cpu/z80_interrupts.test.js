...
describe('Z80 interrupts (IM1, NMI, EI/DI, HALT)', () => {
    it('EI delay: IRQ accepted only after next instruction; IM1 vector 0x0038 and HALT wakes', () => {
    ...
    it('DI prevents IRQ; EI enables after next instruction', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
    ...
    it('NMI vector 0x0066 and 11 cycles, wins over maskable IRQ', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // Program: NOP; HALT
...
//# sourceMappingURL=z80_interrupts.test.js.map