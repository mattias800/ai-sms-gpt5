...
describe('Z80 control flow: JR/JP/CALL/RET/RST/DJNZ', () => {
    it('JR and JR cc have expected cycles and displacement', () => {
    ...
    it('JR cc not taken is 7 cycles', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // JR Z,+1 ; HALT
    ...
    it('DJNZ taken vs not taken cycles', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // DJNZ +2 ; DJNZ -2 ; HALT
    ...
    it('CALL/CALL cc and RET/RET cc and RST', () => {
        const bus = new SimpleBus();
        const mem = bus.getMemory();
        // 0000: CALL 0006 ; HALT
...
//# sourceMappingURL=z80_control_flow.test.js.map