...
console.log('Analyzing optimal Sonic title screen at frame 450');
...
try {
  ...
  const filename = 'traces/sonic_optimal_title_screen.png';
  ...
  if (parseFloat(successRate) >= 75) {
    ...
    console.log(`Sonic title screen at frame 450 shows:`);
