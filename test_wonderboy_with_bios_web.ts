...
console.log('Testing Wonderboy with BIOS (like OpenEmu)...');
...
// Create machine WITH BIOS (like OpenEmu would)
...
console.log('Starting Wonderboy with BIOS...');
...
console.log('Wonderboy with BIOS test completed');
