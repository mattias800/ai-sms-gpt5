...
if (vdpState) {
  ...
  console.log(`R0: 0x${vdpState.regs[0].toString(16)} (binary: ${vdpState.regs[0].toString(2).padStart(8,'0')})`);
  console.log(`R1: 0x${vdpState.regs[1].toString(16)} (binary: ${vdpState.regs[1].toString(2).padStart(8,'0')})`);
  ...
  if (vdpState2) {
    console.log('\nAfter 61 frames:');
    console.log(`R0: 0x${vdpState2.regs[0].toString(16)}`);
    console.log(`R1: 0x${vdpState2.regs[1].toString(16)}`);
